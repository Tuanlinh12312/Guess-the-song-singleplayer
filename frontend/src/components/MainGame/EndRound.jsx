  ...
  return (
    <div className="flex flex-col items-center h-full w-full justify-center backdrop-blur-lg">
      <div className="bg-cover bg-fixed bg-b1 bg-no-repeat w-1/2 h-[calc(50%-40px)] flex flex-col items-center rounded-3xl">
        <h1 className="text-5xl font-coiny font-bold tracking-wide text-center w-full text-orange-950 mt-4">
          Round Ended
        </h1>

        {/* ✅ White background only around content */}
        <div className="bg-white bg-opacity-50 p-4 rounded-2xl shadow-lg flex items-center gap-4 mt-5 justify-between w-2/3 mx-4">
          <img
            src={song.thumbnail}
            alt="Song Thumbnail"
        ...
        <div className="flex flex-col justify-start items-center h-full w-full">
            <button
              className="flex justify-center items-center mt-3 relative w-56 h-32"
              onClick={onNextRound}>
              <img
